 ...
 */
package com.gaoshuai.androidarchitecturemvp.base.basequickadapter;
...
import com.gaoshuai.androidarchitecturemvp.base.basequickadapter.animation.AlphaInAnimation;
import com.gaoshuai.androidarchitecturemvp.base.basequickadapter.animation.BaseAnimation;
import com.gaoshuai.androidarchitecturemvp.base.basequickadapter.animation.ScaleInAnimation;
import com.gaoshuai.androidarchitecturemvp.base.basequickadapter.animation.SlideInBottomAnimation;
import com.gaoshuai.androidarchitecturemvp.base.basequickadapter.animation.SlideInLeftAnimation;
import com.gaoshuai.androidarchitecturemvp.base.basequickadapter.animation.SlideInRightAnimation;
import com.gaoshuai.androidarchitecturemvp.base.basequickadapter.entity.IExpandable;
import com.gaoshuai.androidarchitecturemvp.base.basequickadapter.loadmore.LoadMoreView;
import com.gaoshuai.androidarchitecturemvp.base.basequickadapter.loadmore.SimpleLoadMoreView;
import com.gaoshuai.androidarchitecturemvp.base.basequickadapter.util.MultiTypeDelegate;
...
public abstract class BaseQuickAdapter<T, K extends BaseViewHolder> extends RecyclerView.Adapter<K> {
    ...
    private static final int NETWORK_VIEW = 0x00000888;
    ...
    /**
     * PullRefreshUtil end, no more data
     */
...
//        mLoadMoreView.se
    ...
    public K onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            ...
            case EMPTY_VIEW:
                ...
                break;
            case NETWORK_VIEW:
                baseViewHolder = createBaseViewHolder(mNetworkErrorLayout);
                break;
            case FOOTER_VIEW:
    ...
    public void setNetworkErrorView(View emptyView) {
        boolean insert = false;
        if (mNetworkErrorLayout == null) {
            mNetworkErrorLayout = new FrameLayout(emptyView.getContext());
            final LayoutParams layoutParams = new LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT);
            final ViewGroup.LayoutParams lp = emptyView.getLayoutParams();
            if (lp != null) {
                layoutParams.width = lp.width;
        ...
        mNetworkErrorLayout.removeAllViews();
        mNetworkErrorLayout.addView(emptyView);
        mIsUseEmpty = true;
        if (insert) {
            if (getEmptyViewCount() == 1) {
                int position = 0;
